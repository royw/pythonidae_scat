# -*- coding: utf-8 -*-
#
# Pythonidae Scat documentation build configuration file, created by
...
project_name = u'Pythonidae Scat'
project_title = u'{project_name} Documentation'.format(project_name=project_name)
project_author = u'royw'
project_author_email = u'roy@wright.org'
project_description = u'Python Articles'
project_package = u'pythonidae_scat'
